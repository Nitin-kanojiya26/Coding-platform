            ...
            <div className="border border-zinc-900 bg-[#050507] rounded-xl p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  required
                  className="w-full text-sm rounded-lg border border-zinc-900 bg-zinc-950 px-3.5 py-2 text-white placeholder-zinc-700 outline-none focus:border-zinc-700"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows="6"
                  required
                  className="w-full text-sm font-sans rounded-lg border border-zinc-900 bg-zinc-950 px-3.5 py-2 text-white placeholder-zinc-700 outline-none focus:border-zinc-700 resize-none leading-relaxed"
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[11px] text-zinc-500">Visible to users.</p>
                  </div>
                  <button
                    type="button"
                  ...
                  <div key={idx} className="bg-zinc-950 border border-zinc-900 rounded-lg p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <span className="text-[10px] text-zinc-500 font-mono block">Display Input (Optional)</span>
                        <input
                          placeholder="e.g., s = 'abc'"
                          value={tc.displayInput || ''}
                          onChange={(e) => handleTestCaseChange('sample', idx, 'displayInput', e.target.value)}
                          className="w-full text-xs rounded border border-zinc-900 bg-[#050507] px-3 py-2 text-zinc-300 placeholder-zinc-700 outline-none focus:border-zinc-700"
                        />
                      </div>
                      <div className="space-y-1">
                        <span className="text-[10px] text-zinc-500 font-mono block">Raw Input</span>
                        <input
                          placeholder="abc"
                          value={tc.input}
              ...
              <div className="space-y-4 pt-4 border-t border-zinc-900/50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[11px] text-zinc-500">Used for evaluation.</p>
                  </div>
                  <button
                    type="button"
                ...
                {form.hiddenTestCases.map((tc, idx) => (
                  <div key={idx} className="bg-zinc-950 border border-zinc-900 rounded-lg p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <span className="text-[10px] text-zinc-500 font-mono block">Display Input</span>
                        <input
            ...
            <div className="border border-zinc-900 bg-[#050507] rounded-xl p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full text-sm rounded-lg border border-zinc-900 bg-zinc-950 px-3.5 py-2 text-white outline-none focus:border-zinc-750 cursor-pointer"
                >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  onChange={handleTags}
                  className="w-full text-sm rounded-lg border border-zinc-900 bg-zinc-950 px-3.5 py-2 text-zinc-300 placeholder-zinc-700 outline-none focus:border-zinc-700"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows="2"
                  className="w-full text-sm rounded-lg border border-zinc-900 bg-zinc-950 px-3.5 py-2 text-zinc-300 placeholder-zinc-700 outline-none focus:border-zinc-700 resize-none"
